...
class ChatEngine:
    ...
    def _setup_openai_client(self):
        ...
        try:
            # 从环境变量获取OpenAI配置
            openai_config = self.app_settings.get_openai_config()
            ...
            # 设置代理（如果配置了）
            proxies = {}
            if openai_config['http_proxy']:
                proxies['http'] = openai_config['http_proxy']
            if openai_config['https_proxy']:
                proxies['https'] = openai_config['https_proxy']
